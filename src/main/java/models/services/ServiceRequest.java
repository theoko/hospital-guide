...
public abstract class ServiceRequest implements Comparable<ServiceRequest> {
    ...
    private Location location;          // Origin location
    ...
    private Timestamp claimedTime;      // Time employee claimed request
    private Timestamp completedTime;    // Time employee marked request complete
     ...
     */
    public ServiceRequest(Location location, Priority priority, String description, User requester)
    {
        this.requestID = 0;
