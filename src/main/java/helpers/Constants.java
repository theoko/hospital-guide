...
public class Constants {
    ...
    public static String BOOK_WORKZONE_TABLE = "BOOKWORKZONE";
    ...
    public static String WORKZONE_TABLE = "WORKZONE";
    ...
    public enum Routes {
        ...
        FLOURIST, SECURITY, VISUAL_AUDIO, EXTERNAL_TRANS, PATIENT_INFO, MAP_ALL, ADD, CALENDAR, EDGE_EDITOR, TWO_NODE_SEARCH,
        CREATE_USER, USER_POPUP, EDIT_POPUP, REQUESTS, WORKSPACE_POPUP, WORKZONE_POPUP, IT, PERSCRIPTION, INTERPRETER, INTERNAL_TRANS, GIFT_STORE,
